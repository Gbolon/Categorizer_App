    ...
    if uploaded_file is not None:
        try:
            ...
            if selected_user:
                ...
                fig_power = px.imshow(power_matrix,
                                    labels=dict(x="Test Instance", y="Exercise", color="Power"),
                                    aspect="auto")
                st.plotly_chart(fig_power)
                
                st.subheader("Acceleration Matrix Heatmap")
                fig_accel = px.imshow(accel_matrix,
                                    labels=dict(x="Test Instance", y="Exercise", color="Acceleration"),
                                    aspect="auto")
